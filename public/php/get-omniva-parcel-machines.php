...
try {
    ...
    $formattedLocations = array_map(function($location) {
        ...
        $addressParts = [];
        if (!empty($location['A1_NAME'])) $addressParts[] = $location['A1_NAME']; // County
        if (!empty($location['A2_NAME'])) $addressParts[] = $location['A2_NAME']; // City
        if (!empty($location['A3_NAME'])) $addressParts[] = $location['A3_NAME']; // District
