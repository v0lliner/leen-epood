...
const HomepageContent = () => {
  ...
  const handleSectionUpdate = async (sectionKey, language, updates) => {
    ...
    try {
      const { data, error } = await homepageContentService.updateHomepageSection(sectionKey, language, updates)
  ...
  const handleSaveBothLanguages = async (sectionKey) => {
    ...
    try {
      ...
      const [etResult, enResult] = await Promise.all([
        homepageContentService.updateHomepageSection(sectionKey, 'et', {
          title: etSection.title,
          content: etSection.content,
          image_url: etSection.image_url || null,
          image_path: etSection.image_path || null
        }),
        homepageContentService.updateHomepageSection(sectionKey, 'en', {
  ...
  const sectionConfig = [
    {
      key: 'hero',
      title: 'Peamine sektsioon',
      description: 'Avalehe peamine sektsioon ja kangelaspilt',
      hasImage: true,
      isTextarea: false
    },
    {
      key: 'value1',
      title: 'Väärtus 1',
      description: 'Praktiline esteetika',
      hasImage: false,
      isTextarea: false
    },
    {
      key: 'value2',
      title: 'Väärtus 2',
      description: 'Isikupärane käekiri',
      hasImage: false,
      isTextarea: false
    },
    {
      key: 'value3',
      title: 'Väärtus 3',
      description: 'Visuaalne proportsioon',
      hasImage: false,
      isTextarea: false
    }
  ]
    ...
    <AdminLayout>
      <div className="homepage-container">
        <div className="homepage-header">
          <h1>Avalehe haldus</h1>
          <p>Hallake avalehe sisu eesti ja inglise keeles</p>
        </div>
                  ...
                  <div className="editor-form">
                    ...
                    <div className="bilingual-fields">
                      ...
                      <div className="language-section">
                        ...
                        <div className="form-group">
                          <label htmlFor={`${config.key}-title-et`}>Pealkiri</label>
                          <input
                            type="text"
                            ...
                            placeholder="Sisestage pealkiri eesti keeles"
                          />
                        </div>
                        ...
                        <div className="form-group">
                          ...
                          {config.isTextarea ? (
                            <textarea
                              ...
                              rows={config.key === 'hero' ? 8 : 6}
                              className="form-input"
                              placeholder="Sisestage sisu eesti keeles"
                            />
                          ) : (
                            <input
                              type="text"
                      ...
                      <div className="language-section">
                        ...
                        <div className="form-group">
                          <label htmlFor={`${config.key}-title-en`}>Title</label>
                          <input
                            type="text"
