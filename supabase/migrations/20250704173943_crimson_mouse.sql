/*
  # Fix order_payments policy and add missing elements
  
  1. Changes
    - Add conditional check for policy existence
    - Add conditional check for trigger existence
    - Keep all original functionality
  
  2. Security
    - Maintain RLS policies for order_payments
