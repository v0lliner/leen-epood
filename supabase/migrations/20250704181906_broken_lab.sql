/*
  ...
  1. New Columns
    - `order_number` (text, unique) - Sequential order number in format YYYY-XXXXX
  
  2. Changes
    - Add unique constraint to ensure order numbers are unique
    - Add function to generate sequential order numbers
    - Add trigger to automatically generate order numbers on insert
*/
