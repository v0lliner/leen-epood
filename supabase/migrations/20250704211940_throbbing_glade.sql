/*
  # Schema update to fix image display issues

  1. Storage Configuration
    - Ensures product-images bucket is properly configured as public
    - Sets appropriate file size limits and MIME types
    - Verifies public flag is enabled

  2. Storage Policies
    - Creates clean, simple policies with clear conditions
    - Enables public read access to all storage objects in product-images bucket
    - Provides proper permissions for authenticated users to manage images

  3. Database Permissions
    - Grants explicit schema and table permissions to both anonymous and authenticated users
    - Creates policies allowing public read access to all necessary tables
    - Ensures Row Level Security (RLS) is properly configured
